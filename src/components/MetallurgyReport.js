...
const MetallurgyReport = () => {
    ...
    const getReport = useCallback(async () => {
        ...
        console.log(registeredObservations);
        if (
    ...
    const handleSubmit = async () => {
        if (disposition === null) {
            //toast message
            toast.error("Debe seleccionar una disposición");
            return;
        }
        ...
        const analyzedBy = Number(user.id);
        //axios put
    ...
    return (
        <div>
            <Breadcrumb className="p-3">
                <Breadcrumb.Item href="/metalurgica">
                    Reportes metalúrgicos
                </Breadcrumb.Item>
...
export default MetallurgyReport;
